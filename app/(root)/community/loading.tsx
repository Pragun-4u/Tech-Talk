...
const Loading = () => {
  return (
    <>
      ...
      <article className="mt-10 flex flex-wrap justify-around gap-2">
        {Array(6)
          .fill(" ")
          .map((e: any, index: number) => (
            <Skeleton
              key={index}
              className="background-light700_dark300 light-border h-72 flex w-1/3 flex-col items-center justify-center rounded-2xl border p-8"
            />
          ))}
      </article>
    </>
