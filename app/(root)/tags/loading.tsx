...
const Loading = () => {
  return (
    <>
      ...
      <article className="mt-10 flex flex-wrap gap-2">
        {Array(10)
          .fill(" ")
          .map((e: any, index: number) => (
            <Skeleton
              key={index}
              className="background-light700_dark300 light-border h-36 flex w-60 flex-col items-center justify-center rounded-2xl border p-8"
            />
          ))}
      </article>
    </>
